...
- Browse the [CollectionBuilder Documentation](https://collectionbuilder.github.io/cb-docs/), particularly the [CollectionBuilder-GH Walkthrough](https://collectionbuilder.github.io/cb-docs/docs/walkthroughs/gh-walkthrough/). CollectionBuilder-GH is the version of CollectionBuilder we’ll use for final projects.
